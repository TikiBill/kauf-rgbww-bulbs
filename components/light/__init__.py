...
RESTORE_MODES = {
    ...
    "ALWAYS_ON_WARM_WHITE": LightRestoreMode.LIGHT_ALWAYS_ON_WARM_WHITE,
    "ALWAYS_ON_BRIGHT_WHITE": LightRestoreMode.LIGHT_ALWAYS_ON_BRIGHT_WHITE,
    "ALWAYS_ON_COOL_WHITE": LightRestoreMode.LIGHT_ALWAYS_ON_COOL_WHITE,
